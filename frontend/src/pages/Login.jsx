...
import Idm, {registerUser} from "backend/idm";
...
const Login = () => {
    ...
    return (
        <StyledDiv>
            ...
            <label> Password:<input {...register("password")} type={"password"}/></label><br />
            <button onClick={handleSubmit(submitLogin)}>Login</button> <br />
